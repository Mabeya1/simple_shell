...
/**
 * help_all - Show a list of all available shellby built-in commands.
 */
void help_all(void)
{
...
/**
 * help_alias - Show details about the shellby built-in command 'alias'.
 */
void help_alias(void)
{
...
/**
 * help_cd - Show details about the shellby built-in command 'cd'.
 */
void help_cd(void)
{
...
/**
 * help_exit - Show details about the shellby built-in command 'exit'.
 */
void help_exit(void)
{
...
/**
 * help_help - Show details about the shellby built-in command 'help'.
 */
void help_help(void)
{
